-- ==================== TOPICS ====================
INSERT INTO topic (title, description, created, last_modified) VALUES
...
INSERT INTO user (username, password, email, created, last_modified) VALUES
...
-- ==================== POSTS ====================
INSERT INTO post (title, content, user_id, topic_id, created, last_modified) VALUES
...
-- ==================== COMMENTS ====================
INSERT INTO comment (content, post_id, user_id, created, last_modified) VALUES
...
-- ==================== SUBSCRIPTIONS ====================
INSERT INTO subscription (user_id, topic_id, created) VALUES
    (1, 1, NOW()),  -- alice    -> Java
